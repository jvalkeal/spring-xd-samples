These samples demonstrates a various functionality of using `hdfs` sink and its partitioning functionality. We have 9 different test scenarious with source data sample files.
